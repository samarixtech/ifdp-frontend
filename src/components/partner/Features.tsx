  ...
  return (
    <section className="py-24 bg-gray-50 w-full text-center">
      <h2 className="text-3xl sm:text-4xl font-bold mb-14">
        IFDP brings <span className="text-blue-600">new opportunities</span>
      </h2>
      ...
      <div className="max-w-6xl mx-auto grid gap-10 px-6 sm:grid-cols-1 md:grid-cols-3">
        {features.map((item, i) => (
          <div
            key={i}
            className="bg-white rounded-2xl p-8 flex flex-col items-center text-center shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
