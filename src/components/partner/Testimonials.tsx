...
export default function Testimonials() {
  const testimonials = [
    {
      ...
      text: "Working with IFDP increased my business reach and boosted daily orders.",
    ...
    },
    {
      name: "Omar Latif",
      role: "Cafe Owner",
      text: "IFDP makes managing orders simple and efficient. Highly recommended.",
  ...
  return (
    <section className="py-24 bg-gray-100 w-full">
          ...
          >
            <div className="flex flex-col items-center text-center">
              <img
                src={item.avatar}
                alt={item.name}
                className="w-20 h-20 rounded-full mb-4 object-cover border-2 border-blue-100"
              />
